...
mod tests {
    ...
    #[test]
    fn accepts_an_absolute_https_url_without_changing_it() {
    ...
    #[test]
    fn accepts_the_supported_url_matrix_without_normalizing_the_input() {
        for input in [
            "HTTP://example.com",
    ...
    #[test]
    fn rejects_the_unsupported_or_unsafe_url_matrix() {
        let prefix = "https://example.com/";
